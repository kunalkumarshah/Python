...
# Drop the rows having atleast 1 column with missing value
print(bldg_permits.dropna())
...
# backfill the columns missing values with the next Row-Column value and last row-column as 0
print(bldg_permits.fillna(method = 'bfill', axis=0).fillna("0").head())
